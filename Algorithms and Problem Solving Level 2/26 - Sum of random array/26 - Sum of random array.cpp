// Write a program to fill array with max size 100 with random numbers from 1 to 100, then print the sum of all numbers.
#include <iostream>
#include <cstdlib>
#include <ctime>
using namespace std;
...
int main()
{
	...
	cout << "Sum of all numbers is : " << SumOfAllNumbersInArray(Array, ArrayLength) << endl;
